...
export class GemFarm extends GemFarmClient {
  ...
  async initFarmerWallet(farm: PublicKey) {
    ...
    console.log('New pond with tail #', this.wallet.publicKey.toBase58());
  ...
  async stakeWallet(farm: PublicKey) {
    ...
    console.log('Ducks stopping their swim from pond #', this.wallet.publicKey.toBase58());
  ...
  async unstakeWallet(farm: PublicKey) {
    ...
    console.log('Ducks hopping into pond #', this.wallet.publicKey.toBase58());
